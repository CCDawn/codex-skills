---
name: ccdawn-brt
description: "BRT workflow: Behavior, Review, Test。中文优先的需求对齐和实现前闸门，用来主动揣测用户真实意图，给出有判断价值的候选意图、推荐方案和高信号选择题，让用户通过选择或确认完成对齐，再形成行为契约、评审结论、测试锚点和必要的执行闸门。适用于模糊需求、默认行为、状态流转、权限安全、记忆/恢复、长任务、多步计划、阻塞恢复、验收标准、agent 工作流、promotion/apply/rollback、持久化与公共 API 行为。"
---

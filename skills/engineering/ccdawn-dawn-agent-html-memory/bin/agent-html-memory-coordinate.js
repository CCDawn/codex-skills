...
if (!python) {
  console.error("No Python runtime found. Install Python or run agent_coordination.py directly.");
  process.exit(1);
}

const scriptPath = path.resolve(__dirname, "..", "scripts", "agent_coordination.py");

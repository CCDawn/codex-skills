...
description: "Use when an explicit performance goal, measurable regression, confirmed hot path, large workload, concurrency/cache/streaming decision, or latency/throughput/CPU/memory/I/O/bundle budget needs profiling and an evidence-backed optimization; do not use for routine feature development, speculative cleanup, obvious local inefficiency that the current owner can fix directly, or mandatory benchmarking of every change."
license: MIT
---
